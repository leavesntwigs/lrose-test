...
#define NGATES_4 4
  ...
  TEST(FlagOps, set_bad_flags_where_between_with_clip_gate) {
    ...
    bool bad_flag_mask_expected[NGATES_4] = {true, true, false, false};
  ...
  TEST(FlagOps, bad_flags_logic_below_and) {
    ...
    size_t clip_gate = nGates;
    bool bad_flag_mask[NGATES_4] = {true, false, false, true};
    bool new_bad_flag_mask[NGATES_4] = {true, false, false, true};
    ...
    for (int i=0; i<NGATES_4; i++) {
      EXPECT_EQ(new_bad_flag_mask[i], bad_flag_mask_expected[i]);
    }
  }
  ...
  TEST(FlagOps, bad_flags_logic_above_or) {
    float data[NGATES_4] = {-8,4,5,6};
    bool bnd[NGATES_4] = {true, true, true, true};
    float bad_flag = -3;
  ...
  TEST(FlagOps, bad_flags_logic_between_and) {
    float data[NGATES_4] = {-8,4,5,6};
    bool bnd[NGATES_4] = {true, true, true, true};
    float bad_flag = -3;
    ...
    size_t nGates = NGATES_4;
    size_t clip_gate = nGates;
    bool bad_flag_mask[NGATES_4] = {true, false, true, true};
    bool new_bad_flag_mask[NGATES_4] = {true, false, false, true};
  ...
  TEST(FlagOps, bad_flags_logic_between_xor) {
    float data[NGATES_4] = {-8,6,5,3};
    bool bnd[NGATES_4] = {true, true, true, true};
    float bad_flag = -3;
  ...
  TEST(FlagOps, bad_flags_logic_between_or) {
    float data[NGATES_4] = {-8,4,5,6};
    bool bnd[NGATES_4] = {true, true, true, true};
    float bad_flag = -3;
    ...
    size_t nGates = NGATES_4;
    size_t clip_gate = nGates;
    bool bad_flag_mask[NGATES_4] = {false, true, false, true};
    bool new_bad_flag_mask[NGATES_4] = {true, false, false, true};

    bool bad_flag_mask_expected[NGATES_4] = {false, true, true, true};
  ...
  TEST(FlagOps, clear_bad_flags_complement) {
    ...
    se_clear_bad_flags(complement, bad_flag_mask, new_bad_flag_mask, nGates);
