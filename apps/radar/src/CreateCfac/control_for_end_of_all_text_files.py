...
# this version goes inside the while more data files loop and handles the gotos
#      as continue, so processing of the current sweep/ray is halted and this
#      sweep/ray is skipped.
# 
...
#
    ...
    #
          ...
          if time_ks < tmin :
            ...
            if iend !=  2:  # go to 1   # read next file ! only when end of text file not reached
                continue
          if time_ks > tmax :
    	    iend=2
    	    print(' ')
          ...
          if iend == 2:
              return iend  # iend_equals_2() # go to 2
          else:
          #
          #******************************************************************
...
#
      if(    (abs(acftspd_we) < 10. and abs(acftspd_sn) < 10.)
        ...
        print(' !!!! NO_RAY:',nb_ray
               ...
               ,' !!!!'
        continue  # go to 1 # read next file; replace with continue and move inside while loop
      endif
#----------------------------------------------------------------------
